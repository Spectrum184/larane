...
const ChatContainer: FC = () => {
  return (
    <Layout>
      <div className='h-chat-page w-full flex antialiased text-gray-200 bg-gray-100 dark:bg-gray-900 overflow-hidden rounded-t-xl'>
              ...
              <div className='p-4 flex-none'>
                <form onSubmit=''>
                  <div className='relative'>
                    <label>
                      <input
                        className='rounded-full py-2 pr-6 pl-10 w-full border border-gray-800 focus:border-gray-700 bg-gray-300 dark:bg-gray-800 focus:bg-gray-900 focus:outline-none text-gray-200 focus:shadow-md transition duration-300 ease-in '
                        type='text'
                        value=''
